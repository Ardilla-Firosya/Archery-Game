...
//untuk startgame dan button start
function startGame(){
...
//buat sound effect
var lobbySound = new Audio();
lobbySound.src ="lobby.mp3";

//button start
var startSound = new Audio();
startSound.src = "pop.mp3";
startSound.volume = 0.8;
 
//shoot
var shootSound = new Audio();
shootSound.src = "shSound.mp3";
...
bgSound.src = "medieval.mp3"
bgSound.loop = true;
bgSound.volume = 0.3;
        
//bgsound game berakhir
var endSound = new Audio();
endSound.src = "end.mp3";
endSound.volume = 0.6;

//bgsound kena target tengah
var successSound = new Audio();
successSound.src = "yeay.mp3";

//bgsound highscore
var highScoreSound = new Audio();
highScoreSound.src = "hs.mp3";
...
function loadGame(){
    ...
    startPage.style.backgroundImage = "url('lobbyNew.png')";
    ...
    // efek saat panah kena target utama
...
//window.onload = setTimeout(loadGame,20000);
